...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissionNames = [
            ...
            'screen.academics.index.view',
            'screen.academics.upload.index.view',
            'screen.academics.upload.template.view',
            'screen.reports.index.view',
            ...
            'button.users.index.change_status',
            ...
            'button.instructor.exams.questions.order.duplicate',
            ...
            'db.student_profiles.update',
            'db.student_profiles.delete',
            'db.course_major.select',
            'db.course_major.insert',
            'db.course_major.update',
            'db.course_major.delete',
            'db.course_user.select',
            'db.course_user.insert',
            'db.course_user.update',
            'db.course_user.delete',
            'db.course_student.select',
            'db.course_student.insert',
            'db.course_student.update',
            'db.course_student.delete',
            'db.exam_assignments.select',
            'db.exam_assignments.insert',
            'db.exam_assignments.update',
            'db.exam_assignments.delete',
