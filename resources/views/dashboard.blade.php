        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid gap-6 md:grid-cols-2">
                ...
                @if (auth()->user()->can('screen.groups.index.view') && auth()->user()->can('button.dashboard.group_management'))
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-emerald-200">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold text-gray-900">User Access Management</h3>
